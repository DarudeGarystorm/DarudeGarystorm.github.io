;(function ( $, window, document, undefined ) {
	...
	var pluginName = 'ik_treemenu',
		defaults = {
			'instructions': 'Use up or down arrows to move through menuitems, and enter or spacebar to toggle submenus open and closed.',
		...
		$elem // set all li elements as tree folders and items
			...
			.each(function(i, el) {
				...
				if ($me.children('ul').length) {  // if the current treeitem has submenu
					...
					$me.attr({
						'aira-label': $me.children('span:first').text()
						})
						.children('span')
						.addClass('folder')
						.attr({
